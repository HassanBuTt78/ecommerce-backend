...
router.post("/", [userAuthorize, validator(validationSchemas.orderCreation)], orderController.createOrder);
router.get("/", [userAuthorize], orderController.getOrders);
router.get("/:orderId", [userAuthorize], orderController.getOrderDetails);
router.put("/:orderId", [adminAuthorize, validator(validationSchemas.orderUpdate)], orderController.updateOrder);
